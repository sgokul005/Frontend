        ...
        <div className="mx-auto px-4">
          <div className="flex justify-between items-center">
            ...
            <Link to="/" className="flex items-center py-6">
              <img
                src="https://tse1.mm.bing.net/th?id=OIP.mn7AjpCPG-FDTdtDpM0e2wHaE8&pid=Api&rs=1&c=1&qlt=95&w=165&h=110"
                alt="AIE"
                className="h-8 w-8 mr-2"
              />
              <span className="font-bold text-white text-lg">AIE GADGETS</span>
            </Link>
